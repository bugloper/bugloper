...
### [healthier](https://rubygems.org/search?query=healthier)
...
### [gotenberg](https://rubygems.org/gems/gotenberg)
A Ruby wrapper around [Gotenberg](https://gotenberg.dev) that simplifies PDF generation and document conversion by integrating seamlessly with the Rails asset pipeline.

### [esrever](https://github.com/bugloper/esrever)
...
### [homebrew-seli](https://github.com/bugloper/homebrew-seli)
A Homebrew tap that provides easy installation and updates for the `seli` CLI tool.

### [otoindiff](https://github.com/bugloper/otoindiff)
